...
void SceneManager::DefineObjectMaterials()
{
	...
	glassMaterial.shininess = 120.0;
	glassMaterial.tag = "glass";

	m_objectMaterials.push_back(glassMaterial);

	OBJECT_MATERIAL woodMaterial;
	woodMaterial.diffuseColor = glm::vec3(.6f, .6f, .6f);
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("pointLights[1].position", 8.0f, 8.0f, 2.5f);
	m_pShaderManager->setVec3Value("pointLights[1].ambient", 0.5f, 0.5f, 0.5f);
	m_pShaderManager->setVec3Value("pointLights[1].diffuse", 0.8f, 0.3f, 1.0f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ rotation for the mesh
	XrotationDegrees = 0.0f;
	YrotationDegrees = -035.0f;
	ZrotationDegrees = 0.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 06.0f, 0.0f);
	...
	SetShaderColor(.8, 1, 1, 1);
	SetShaderMaterial("wood");
	//texture for torus 1
	//used metal texture, with basic tiling for a rustic look
	...
	SetShaderColor(.9, 1, 1, 1);
	SetShaderMaterial("glass");
	//texture for torus 2
	//spomge was tiled more for detail preferences
	SetShaderTexture("Sponge");
	SetTextureUVScale(20.0, 20.0);
	// draw the mesh with transformation values
	m_basicMeshes->DrawTorusMesh();

	//draw Box
	scaleXYZ = glm::vec3(15.0f, 15.0f, 15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-10.0f, 10.0f, -10.0f);
	...
	SetShaderColor(1, 1, 1, 1);
	SetShaderMaterial("glass");
	//box was textured using the marble texture
	...
	//draw cylinder
	scaleXYZ = glm::vec3(5.0f, 25.0f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(14.0f, 2.0f, -15.0f);
	...
	//draw cylinder
	scaleXYZ = glm::vec3(40.0f, 20.0f, 20.0f);
	...
	SetShaderColor(1, 1, .4, 1);
	//texture for plane
	//wood texture was used to mimic a tabletop
